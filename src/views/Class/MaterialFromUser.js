...
const MaterialFromUser = () => {
    ...
    useEffect(() => {
        ...
        ClassService.getMaterialsFromUser().then((res) => {
            setMaterials(res);
        });
    },[clas, lesson_id]);
        ...
        <div>
            <UserLayout>
                ...
                <Card className="default-card px-30 py-30">
                    <div className="title-little">Materi Terkait Dari Mahasiswa</div>
...
export default MaterialFromUser;